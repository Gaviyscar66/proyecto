    ...
    <nav className="bg-transparent px-6 md:px-8 py-4 w-full relative z-[100]">
      <div className="max-w-6xl mx-auto flex justify-between items-center">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link to="/productos" className="text-white font-medium hover:text-black  transition duration-300 ease-in-out drop-shadow-md">
            Nuestros Productos
          </Link>
          <Link to="/nosotros" className="text-white font-medium hover:text-black transition duration-300 ease-in-out drop-shadow-md">
            Sobre Nosotros
          </Link>
          <Link to="/seguridad" className="text-white font-medium hover:text-black transition duration-300 ease-in-out drop-shadow-md">
            Seguridad
          </Link>
        </div>
        ...
        <Link
          to="/login"
          className="hidden md:block bg-black text-white px-6 py-2 rounded-full font-semibold hover:bg-neutral-900 transition-all duration-300 shadow-xl border border-white/10"
        >
          Iniciar Sesion
        </Link>
